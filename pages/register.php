...
<html lang="en">
  ...
  <body>
  <div class="container">
    <form class="form-horizontal" role="form" method="POST" action="../connects/register.php">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="nick" class="form-control" id="name"
                               placeholder="Twój nick" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="password" name="password-c" class="form-control"
                               id="Potwierdź hasło" placeholder="Password" required>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-control-feedback">
                        <span class="text-danger align-middle">
                        <?php
                                if(isset($_SESSION["err_password_c"]))
                                if($_SESSION["err_password_c"] != ""){
                                    
                                    echo '<i class="fa fa-close"> ';
                                    echo $_SESSION["err_password_c"];
                                    echo '</i>';
                                    $_SESSION["err_password_c"] = "";
                                }
                            ?>
                        </span>
                </div>
